...
class DashboardController extends CI_Controller {
	...
	public function index()
	{
		...
		$data['dt_get_most_visit']= $this->PinModel->get_most_visit('pin_name',1);
		$data['dt_get_stats_total_pin_by_category']= $this->PinModel->get_most_category(6); // for now
		$data['dt_get_stats_total_visit_by_category']= $this->PinModel->get_most_visit('pin_category',6); // for now
