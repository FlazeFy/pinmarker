        ...
        <form method="POST" action="/RegisterController/register" id="register-form">
            <div style="height:90vh; padding-top:calc(var(--spaceJumbo)*3);">
                <div class="d-flex justify-content-between">
                    ...
                    <a class="btn btn-danger pt-2 px-4" href="/LoginController" id='back-page-btn'><i class="fa-regular fa-circle-xmark"></i> Back to Login</a>
                </div><br>
            ...
            if(is_check){
                ...
                $('#user_profile_holder').html(`
                    ...
                    <div id="btn-regis-holder">
                        <a class="btn btn-success px-3" onclick="navProfile()" id='submit-register-btn'><i class="fa-solid fa-arrow-right-to-bracket me-2"></i> Create Account</a>
                    </div>
                `)
            } else {
                is_process = false
