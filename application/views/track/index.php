        ...
        <?php if (!$is_mobile_device): ?>
            <div class="d-flex justify-content-start">
                ...
                <form action="TrackController/reset_filter_date" method="POST">
                    <button class="btn btn-danger rounded-pill py-3 px-4 me-2 mb-4"><i class="fa-solid fa-rotate"></i> Reset</button>
                </form>
        ...
        <?php else: ?>
            <div class="row">
                <div class="col-4 p-0 ps-2">
                    <a class="btn btn-dark mb-2 rounded-pill p-2 w-100" data-bs-toggle="modal" data-bs-target="#historyTrackModal" onclick="getHistoryTrack()"><i class="fa-solid fa-table"></i> Detail</a>
                </div>
                <div class="col-5 px-1">
                    <a class="btn btn-dark mb-2 rounded-pill p-2 w-100" data-bs-toggle="modal" data-bs-target="#relatedPinTrackModal"><i class="fa-solid fa-table"></i> Pin x Track</a>
                </div>
                <div class="col-2 p-0">
                    <form action="TrackController/reset_filter_date" method="POST">
                        <button class="btn btn-danger rounded-pill p-2 mb-2 w-100"><i class="fa-solid fa-rotate"></i></button>
                    </form>
                </div>
                <div class="col-6">
                    <?php $this->load->view('track/day_route'); ?>
