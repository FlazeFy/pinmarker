<div class="card mb-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="row">
                <div class="col-6">
                    <input name="pin_lat" id="pin_lat" type="text" maxlength="144" value="<?= $dt_detail_pin->pin_lat ?>" class="form-control form-validated" onblur="check_nearest_pin()" required/>
                </div>
                <div class="col-6">
                    <input name="pin_long" id="pin_long" type="text" maxlength="144" value="<?= $dt_detail_pin->pin_long ?>" class="form-control form-validated" onblur="check_nearest_pin()" required/>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
    ...
    <div class="row mt-4">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <button class="btn btn-outline-primary w-100 py-3 mb-2" id='submit-visit-wdir-btn'><i class="fa-solid fa-location-arrow"></i> Save Changes & Set Direction</button>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
