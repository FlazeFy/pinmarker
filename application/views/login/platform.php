<h2 class="fw-bold text-center" style="margin-top:20vh;">WHERE YOU CAN USE OUR APPS?</h2>
<div class="row text-center">
    <div class="col-4 py-3">
        <img class='img img-fluid mt-3 mx-auto d-block' style="height:40%;" src='http://127.0.0.1:8080/public/images/mobile.png'>
        <h2 class="fw-bold">Mobile</h2>
        <p class="text-secondary mb-0">For better experience with <b>TRACKER</b> feature</p>
    </div>
    <div class="col-4 py-3">
        <img class='img img-fluid mt-3 mx-auto d-block' style="height:40%;" src='http://127.0.0.1:8080/public/images/web.png'>
