<div class="d-block mx-auto <?php if (!$is_mobile_device){ echo "p-4"; } else { echo "p-2"; } ?> position-relative bg-white" style="max-width: 480px; border: var(--spaceMini) solid black; border-radius: 15px; margin-top:20vh;">
    ...
    <div class="mt-3">
        <a class="btn btn-socmed" href="javascript:void(0)" onclick="window.open('https://t.me/pinmarker_bot', '_blank')" id='telegram-open-btn'><i class="fa-brands fa-telegram"></i></a>
        <a class="btn btn-socmed" href="" id='discord-open-btn'><i class="fa-brands fa-discord"></i></a>
    </div>
</div>