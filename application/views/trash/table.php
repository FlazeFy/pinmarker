<a class="btn btn-danger mb-4 rounded-pill <?php if (!$is_mobile_device){ echo "py-3"; } else { echo "py-2"; } ?> px-4 me-2" href="/ListController" id='back-page-btn'><i class="fa-solid fa-arrow-left"></i> Back</a>
