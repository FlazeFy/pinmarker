        ...
        echo "
            <div class='col-lg-4 col-md-6 col-sm-12 col-12 grid-item'>
                <div class='pin-box mb-4'>
                    ...
                    <a class='btn btn-primary px-2 py-1 me-2 see-detail-btn' href='/DetailGlobalController/view/$dt->id'><i class='fa-solid fa-circle-info'></i> See Detail</a>
                    <a class='btn btn-primary-outline px-2 py-1 share-global-pin-btn'><i class='fa-solid fa-paper-plane'></i> Share</a>
                </div>
            </div>
        ";
    }
