...
<body>
    <div class="content">
        ...
        <a class="btn btn-dark btn-main-page rounded-pill" href="/AddVisitController"><i class="fa-solid fa-plus"></i> Add New Visit</a>
        <a class="btn btn-dark btn-main-page rounded-pill" href="/HistoryController/print_visit"><i class="fa-solid fa-print"></i> Print</a>
