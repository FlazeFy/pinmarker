    ...
    <div class="content">
        <div class="d-flex justify-content-between">
            <div class="d-flex justify-content-start w-100">
                ...
                <a class="btn btn-dark btn-menu-main" href="/ListController/print_pin_doc" style='bottom:calc(7*var(--spaceXLG));' id='print-btn'><i class="fa-solid fa-print"></i><?php if(!$is_mobile_device){ echo " Print";} ?></a>
                <?php 
